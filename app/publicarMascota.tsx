...
export default function PerfilScreen() {
  ...
  const [user, setUser] = useState<MascotaProfile | null>(null);
  ...
  const fetchMascotaProfile = useCallback(async () => {
    setLoading(true);
    setError(null);
    ...
    try {
      ...
      console.log('Llamando a:', `${API_URL}/publicarMascota`);

      const response = await axios.get<MascotaProfile>(`${API_URL}/publicarMascota`, {
        headers: {
  ...
  if (error) {
    return (
      <View style={[styles.container, styles.center]}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={fetchMascotaProfile}>
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.detailRow}>
          ...
          <Text style={styles.value}>{user.titulo}</Text>
        </View>

        <View style={styles.detailRow}>
          <Text style={styles.label}>Email:</Text>
          <Text style={styles.value}>{user.localidad}</Text>
        </View>

        <View style={styles.detailRow}>
          <Text style={styles.label}>Teléfono:</Text>
          <Text style={styles.value}>{user.descripcion}</Text>
        </View>
        <Image source={{ uri: user.image }} style={styles.imageFlat} />
